...
const Ready = () => {
  return (
    <div>
      <div className="bg-white w-auto h-full mx-2 mt-10  font-[600] rounded-lg">
        <div className="flex justify-center text-center p-8 font-[500] text-black">
          ...
          Get in touch now with our customer service representive for more details.<br></br> Request more informations about our services for your business needs.
          </p>
    ...
    <button className="h-[50px]  px-6 btn rounded-[50px] shadow-md  transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-140  duration-300 ">
                <span className='text-white text-[15px] px-8  font-[700]'>Get Started</span>
              </button>
    </div>
          </div>
