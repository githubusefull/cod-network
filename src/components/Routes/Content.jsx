...
const Content = () => {
  ...
  return (
    <div>
      <div className="bg-white w-auto h-full mx-5 mt-20  font-[600] rounded-lg">
        <div className="flex justify-center  p-8 text-4xl font-[500] text-black">
          <span className="font-[800] p-16 text-center">
            We Enable Everyone to Start <span className='growandscale'>Grow and Scale</span> Ecommerce Business in the
  ...
  <img src={src} alt='' className='w-20 h-15 mx-auto'/>
   <p className='mt-4 text-gray-500'>{title}</p>
    ...
    <button className="h-[50px]  px-6 btn rounded-[50px] shadow-md  transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-140  duration-300 ">
                <span className='text-white text-[15px] px-8  font-[700]'>Get Started Now</span>
              </button>
    </div>
