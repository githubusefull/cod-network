  ...
  return (
    <div>
      <div className="bg-white w-auto h-full mx-5 mt-10  font-[600] rounded-lg">
        {/*    
        <div className="flex justify-center  p-8 text-4xl font-[500] text-black">
          <span className="font-[800] p-16 text-center">
            We Enable Everyone to Start{" "}
            <span className="growandscale">Grow and Scale</span> Ecommerce
            Business in the Middle East, Africa and Beyond.
          </span>
        </div>*/}
            
        <div className="flex justify-center p-10 text-4xl font-[500] text-black">
          <span className="font-[800] p-8 mt-8 text-center">
            
            <span className="growandscale">JUMLA MAROC</span>
        ...
        <div className="flex justify-center text-1xl font-[500] text-black">
          ...
          <span className="font-[600]  text-center">
            <span className="growandscale">Jumla Maroc </span>est plus qu'un simple service de vente en gros,<br></br> c'est
            votre principal partenaire pour la fourniture de grandes quantités <br></br>
            de produits et de marchandises. Nous sommes là pour comprendre les
            besoins <br></br> de votre entreprise et simplifier vos opérations. Que vous
            recherchiez des produits <br></br>de qualité à distribuer, des consommables
            ou des matériaux indispensables à <br></br> votre production Vente en Gros
            Diversité de Produits Réseau de Fournisseurs<br></br> Étendu Expertise en
            Négociation
          </span>
        </div>
        </div>
